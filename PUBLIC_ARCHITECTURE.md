...
The authorization layer also enforces interaction ownership boundaries: categories of interaction — grief, medical decisions, relationship-defining choices, emotional crises — that agents should not handle autonomously regardless of what the principal has delegated.
...
This document describes Interlock's architecture at the layer and principle level. It intentionally omits:

- Schema and data model specifications
- Implementation choices within each layer
- Deployment and operational architecture
- Evaluation mechanics and outcome contract design
- Specific technology selections within layers

Those details are in a private working repository. This document is intended to communicate the scope, positioning, and design philosophy to collaborators, potential partners, and observers following the space.

If you are working on related problems and want to go deeper, reach out: [tmargo@gmail.com](mailto:tmargo@gmail.com)
